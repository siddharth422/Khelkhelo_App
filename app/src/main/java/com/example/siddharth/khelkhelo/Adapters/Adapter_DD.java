...
public class Adapter_DD extends RecyclerView.Adapter<Adapter_DD.MyHolder>{
    ...
    public Adapter_DD(ArrayList<Model> modelClass,Context context)
    {
    ...
    @NonNull
    @Override
    public Adapter_DD.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.player_cardview,parent,false);
        return new Adapter_DD.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_DD.MyHolder holder, int position) {

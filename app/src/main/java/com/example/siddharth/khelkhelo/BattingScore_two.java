...
public class BattingScore_two extends AppCompatActivity implements Adapter_For_battingscore.OnItemClickListener, SwipeRefreshLayout.OnRefreshListener{
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DATA_B,
                    ...
                    public void onResponse(String response) {
                       ...
                       // progressDialog.dismiss();
                        try {
                            ...
                            adapterB=new Adapter_For_bowling(modelClass2,BattingScore_two.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(BattingScore_two.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
                ...
                new Response.Listener<String>() {
                    ...
                    //    progressDialog.dismiss();
                        try {
                            ...
                            adapter=new Adapter_For_battingscore(modelClass,BattingScore_two.this);
                            recyclerView.setAdapter(adapter);
                            adapter.setOnItemClickListener(BattingScore_two.this);
                            swipeRefreshLayout.setRefreshing(false);
                        } catch (JSONException e) {
                            e.printStackTrace();
                        }

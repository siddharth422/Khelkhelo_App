...
public class Adapter_for_Scored extends RecyclerView.Adapter<Adapter_for_Scored.MyHolder>{
    ...
    public Adapter_for_Scored(ArrayList<Model_for_homescoreboard> modelClass,Context context)
    {
    ...
    @NonNull
    @Override
    public Adapter_for_Scored.MyHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext())
                .inflate(R.layout.resultcardview,parent,false);
        return new Adapter_for_Scored.MyHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull Adapter_for_Scored.MyHolder holder, int position) {

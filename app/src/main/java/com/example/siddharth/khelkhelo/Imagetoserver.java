...
public class Imagetoserver extends AppCompatActivity implements View.OnClickListener{
    ...
    private static final String UPLOAD_URL ="https://siddharthsoni020.000webhostapp.com/upload.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        account.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(Imagetoserver.this, Logout.class);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST,
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String s) {
                        ...
                        loading.dismiss();https://worldfree4u.club/bollywood-720p-movies/
    ...
    public void onClick(View v) {
        ...
        if(v==next)
        {
            startActivity(new Intent(Imagetoserver.this,DisplayImage.class));
        }

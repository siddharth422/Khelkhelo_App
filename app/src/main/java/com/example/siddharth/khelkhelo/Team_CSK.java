...
public class Team_CSK extends AppCompatActivity  implements PlayerAdapter.OnItemClickListener{
    private static final String URL_DATA = "https://siddharthsoni020.000webhostapp.com/playerdata.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Team_CSK.this,2));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter=new PlayerAdapter(modelClass,Team_CSK.this);
                            recyclerView.setAdapter(adapter);
                            adapter.setOnItemClickListener(Team_CSK.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Team_CSK.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });

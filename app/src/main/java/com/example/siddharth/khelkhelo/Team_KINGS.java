...
public class Team_KINGS extends AppCompatActivity implements Adapter_DD.OnItemClickListener{
    private static final String URL_DATA = "https://siddharthsoni020.000webhostapp.com/Kxip.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Team_KINGS.this,2));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter=new Adapter_DD(modelClass,Team_KINGS.this);
                            recyclerView.setAdapter(adapter);
                            adapter.setOnItemClickListener(Team_KINGS.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Team_KINGS.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });

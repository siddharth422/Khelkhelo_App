...
public class Team_KKR extends AppCompatActivity  implements Adapter_DD.OnItemClickListener{
    private static final String URL_DATA = "https://siddharthsoni020.000webhostapp.com/kkr.php";
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Team_KKR.this,2));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter=new Adapter_DD(modelClass,Team_KKR.this);
                            recyclerView.setAdapter(adapter);
                            adapter.setOnItemClickListener(Team_KKR.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Team_KKR.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });

...
import com.example.siddharth.khelkhelo.Adapters.Adapter_RCB;
...
public class Team_RCB extends AppCompatActivity  implements Adapter_RCB.OnItemClickListener
{
    private static final String URL_DATA = "https://siddharthsoni020.000webhostapp.com/RCB.php";
    private RecyclerView recyclerView;
    private Adapter_RCB adapter;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(Team_RCB.this,2));
        ...
        StringRequest stringRequest=new StringRequest(Request.Method.POST, URL_DATA,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            adapter=new Adapter_RCB(modelClass,Team_RCB.this);
                            recyclerView.setAdapter(adapter);
                            adapter.setOnItemClickListener(Team_RCB.this);
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        Toast.makeText(Team_RCB.this, "Error" + error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
